...
import { TextSubtitle, TextTitle, TextWrapper, TextParagraph } from './styles'
...
export const AboutUs = () => {
  return (
    <div>
      ...
      />
      <TextWrapper>
        <TextTitle>O Centro Pokémon</TextTitle>
        <TextSubtitle>Como funciona a cura de um pokémon?</TextSubtitle>
        <TextParagraph>
        ...
        <TextSubtitle>Uma tradição de mais de 20 anos</TextSubtitle>
        <TextParagraph>
        ...
        <TextSubtitle>O melhor para seu pokémon</TextSubtitle>
        <TextParagraph>
          ...
          felis. Nulla nec felis elementum, tristique ligula vel, aliquet erat.
          Nullam a magna tristique, semper nulla id, bibendum tellus. Etiam
          eleifend tortor in sollicitudin maximus. Proin dignissim feugiat urna,
          non imperdiet ligula ullamcorper ut. Nam velit quam, dignissim at
          lorem quis, facilisis vulputate sem. Quisque id sapien vehicula,
          hendrerit odio a, suscipit lectus. Phasellus aliquam erat non viverra
          egestas. Sed quis ipsum eu sem molestie accumsan sit amet non odio. In
          libero nisl, hendrerit at tortor eu, commodo posuere ipsum. Morbi
          bibendum vel nulla in ullamcorper. Sed ultricies, est sed molestie
          varius, dolor ipsum ultricies enim, at dapibus nulla erat eu purus.
          Pellentesque non ultrices nulla.
        </TextParagraph>
        <TextSubtitle>Alta Tecnologia</TextSubtitle>
        <TextParagraph>
